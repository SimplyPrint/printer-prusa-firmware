...
pipenv run python3.12 utils/build.py --preset $presets --build-type release --final --signing-key "${ROOTDIR}/firmware_signing_key.pem" --build-dir "${ROOTDIR}/build" --bootloader yes -D WEBSOCKET:BOOL=$websocket
